...
<template>
  <div class="p-6">
    <div class="flex justify-between items-center mb-4">
      ...
      <NuxtLink to="/events/create" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
        + Create Event
      </NuxtLink>
    </div>
    ...
    <div v-if="events.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
